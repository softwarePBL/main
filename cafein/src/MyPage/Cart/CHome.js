...
const Tmp = () => {
 ...
 <ul className="cartList">
      ...
      <li style={{ margin: 0, paddingLeft: 0 }}>
        ...
        <li className="quantityConts">
          <input type="number"></input></li>
        <li className="amountConts">
        {userCartItem.ProductPrice} <br /></li>
        <button name="delete" className="btn btn-primary btn-md cartDeleteButton" onClick={() => handleDelete(userCartItem.id)}> 삭제 </button>
        </ul>
