                ...
                <> 
                     <div className="review-container">
                        ...
                        {reviewObj.reviewimage && (
                            ...
                            <img src={reviewObj.reviewimage} width="200px" height="150px" alt="Review" />
                            </div>
                        )}
                        {isOwner && (
                            <div className="review-buttons">
                                <div className="button-wrapper">
                                    <button onClick={onDeleteClick} className="modifyReview">삭제</button>
                                    <button onClick={toggleEditing} className="deleteReview">수정</button>
                                </div>
                            </div>
                        )}
                            </div>
